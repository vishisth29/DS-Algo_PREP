...
//		System.out.println(value);
		...
		int GLOBAL = 200;
		System.out.println(GLOBAL);
		System.out.println(FuncDemos.GLOBAL);
		System.out.println(DemoGlobalScopes(one));
		
		// Part 9 - Scopes in blocks
		if(one < two){
//			int one = 20; because outer is available inside
			int three = 30;
		}
//		System.out.println(three); inner not available outside
